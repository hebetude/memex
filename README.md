...
[**Live web version here**](https://ennuyant.com/thepit/)

My fork of **Memex**, a [personal knowledge base](https://scholar.colorado.edu/csci_techreports/931/). I feel like I will change stuff but what changes remains to be seen. Categories will be added as a structure hopefully (naturally) emerges. Below is the mostly unchanged intro from the original repo.
